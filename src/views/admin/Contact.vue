        ...
        <v-card flat>
          <v-card-text>
            <v-form>
              ...
              <v-btn color="success" @click="upload">Create</v-btn>
            </v-form>
          </v-card-text>
        </v-card>
      </v-tab-item>
    ...
    update() {
      if (this.selected_id != null && this.title != null && this.name != null && this.school != null) {
        this.$axios.put('/api/admin/contact', {
          ...
          alert("Update contact info successfully.")
        }).catch(() => {
    ...
    deleteContact() {
      if (this.selected_id != null) {
        this.$axios.delete('/api/admin/contact/' + this.selected_id).then(() => {
          alert("Delete contact info successfully.")
        }).catch(() => {
          alert("Unknown error occurred.")
        })
      } else {
    ...
    upload() {
      if (this.new_title != null && this.new_name != null && this.new_school != null) {
        this.$axios.post('/api/admin/contact', {
          ...
          alert("Upload contact info successfully.")
        }).catch(() => {
          alert("Unknown error occurred.")
        })
      } else {
